...
def divide(plane, inputCurve, params):
    ...
    curves = []
    lines = ghcomp.Explode(inputCurve,True)[0]
    pts = [ ghcomp.DivideCurve(line,2,True)[0] for line in lines ] #중점
    ...
    if param == 1:
        ...
        curves.append(rh.Rectangle3d(plane, pts[0][1], pts[2][0]))
        print curves
        return curves + divide(plane, curves[1], params) + divide(plane, curves[0], params)
    elif param == 4:
        curves.append(rh.Rectangle3d(plane, pts[1][0], pts[3][1]))
        curves.append(rh.Rectangle3d(plane, pts[1][1], pts[3][0]))
        print curves
        ...
        curves.append(rh.Rectangle3d(plane, pts[0][0], pts[2][1]))
        curves.append(rh.Rectangle3d(plane, pts[0][1], pts[2][0]))
        return curves + divide(plane, curves[1], params)
#    elif param == 4:
#        curves.append(rh.Rectangle3d(plane, pts[1][0], pts[3][1]))
#        curves.append(rh.Rectangle3d(plane, pts[1][1], pts[3][0]))
#        print curves
